...
class TesseractOcrService
{
    ...
    public function extractTextFromEtiquette(string $imagePath): array
    {
        ...
        try {
            ...
            // Le module Composer teserract n'est pas suffisant, il faut installer l'executable binaire au niveau du système
            // Voir le lien : https://tesseract-ocr.github.io/tessdoc/Installation.html ou https://tesseract-ocr.github.io/tessdoc/Installation.html
            ...
            // TODO si tesseract n'est pas installé sur le système, ceci lance une erreur.
            //   Lorsque ce sera intégré, si tesseract ne fonctionne pas, ne pas pénaliser tout le site mais juste désactiver la fonctionnalité
            $text = $tesseract->run();
    ...
    protected function estimateConfidence(string $text): int
    {
        ...
        if (preg_match('/[^\x20-\x7E\xC0-\xFF]/', $text)) {
            $confidence -= 25;
        }
